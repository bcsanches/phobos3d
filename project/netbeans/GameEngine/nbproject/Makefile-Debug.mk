...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk ../../../bin/libPH_GameEngined.so

../../../bin/libPH_GameEngined.so: ${OBJECTFILES}
	${MKDIR} -p ../../../bin
	${LINK.cc} -shared -o ../../../bin/libPH_GameEngined.so -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
