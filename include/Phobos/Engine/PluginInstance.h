...
namespace Phobos
{
	namespace Engine
	{
		PH_DECLARE_NODE_PTR(PluginInstance);

		class PluginInstance: public Node
		{
			public:
				static PluginInstancePtr_t Create(const String_t &name);

				PluginInstance(const String_t &name);
				~PluginInstance();
