...
void Phobos::OgreEngine::Console::OnFinalize()
{
...
void Phobos::OgreEngine::Console::OnEditBoxChanged()
{
	m_fEditBoxChanged = true;
}
	
void Phobos::OgreEngine::Console::OnTextListChanged()
{
	m_fTextBufferChanged = true;
}

void Phobos::OgreEngine::Console::OnUpdate(void)
{
...
void Phobos::OgreEngine::Console::OnToggleConsole()
{
...
void Phobos::OgreEngine::Console::UpdateRenderInfo()
{
	using namespace Ogre;
