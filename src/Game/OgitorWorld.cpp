...
namespace Phobos
{
	namespace Game
	{
		...
		void OgitorWorld::LoadTerrainGroup(const Register::Table &dict)
		{
		...
		void OgitorWorld::LoadTerrainPage(const Register::Table &terrainPageTable, const Register::Table &worldEntityDef)
		{
		...
		void OgitorWorld::LoadNodeObject(TempStaticObject_s &temp, const Register::Table &dict)
		{
		...
		void OgitorWorld::LoadLightObject(TempStaticObject_s &temp, const Register::Table &dict)
		{
				...
				default:
					{
						...
						PH_RAISE(INVALID_PARAMETER_EXCEPTION, "OgitorWorld::LoadLightObject", stream.str());
					}
					break;
			}
