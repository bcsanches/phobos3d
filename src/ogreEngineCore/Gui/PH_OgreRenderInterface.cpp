...
Phobos::Gui::RenderInterfaceOgre_c::RenderInterfaceOgre_c(unsigned int window_width, unsigned int window_height)
{
...
Phobos::Gui::RenderInterfaceOgre_c::~RenderInterfaceOgre_c()
{
}

// Called by Rocket when it wants to render geometry that it does not wish to optimise.
void Phobos::Gui::RenderInterfaceOgre_c::RenderGeometry(Rocket::Core::Vertex* ROCKET_UNUSED(vertices), int ROCKET_UNUSED(num_vertices), int* ROCKET_UNUSED(indices), int ROCKET_UNUSED(num_indices), Rocket::Core::TextureHandle ROCKET_UNUSED(texture), const Rocket::Core::Vector2f& ROCKET_UNUSED(translation))
{
	// We've chosen to not support non-compiled geometry in the Ogre3D renderer.
}

// Called by Rocket when it wants to compile geometry it believes will be static for the forseeable future.
Rocket::Core::CompiledGeometryHandle Phobos::Gui::RenderInterfaceOgre_c::CompileGeometry(Rocket::Core::Vertex* vertices, int num_vertices, int* indices, int num_indices, Rocket::Core::TextureHandle texture)
{
...
void Phobos::Gui::RenderInterfaceOgre_c::RenderCompiledGeometry(Rocket::Core::CompiledGeometryHandle geometry, const Rocket::Core::Vector2f& translation)
{
...
void Phobos::Gui::RenderInterfaceOgre_c::ReleaseCompiledGeometry(Rocket::Core::CompiledGeometryHandle geometry)
{
...
void Phobos::Gui::RenderInterfaceOgre_c::EnableScissorRegion(bool enable)
{
...
void Phobos::Gui::RenderInterfaceOgre_c::SetScissorRegion(int x, int y, int width, int height)
{
	scissor_left = x;
	scissor_top = y;
...
bool Phobos::Gui::RenderInterfaceOgre_c::LoadTexture(Rocket::Core::TextureHandle& texture_handle, Rocket::Core::Vector2i& texture_dimensions, const Rocket::Core::String& source)
{
...
bool Phobos::Gui::RenderInterfaceOgre_c::GenerateTexture(Rocket::Core::TextureHandle& texture_handle, const Rocket::Core::byte* source, const Rocket::Core::Vector2i& source_dimensions)
{
...
void Phobos::Gui::RenderInterfaceOgre_c::ReleaseTexture(Rocket::Core::TextureHandle texture)
{
	delete ((RocketOgre3DTexture*) texture);
}

// Returns the native horizontal texel offset for the renderer.
float Phobos::Gui::RenderInterfaceOgre_c::GetHorizontalTexelOffset()
{
	return -render_system->getHorizontalTexelOffset();
}

// Returns the native vertical texel offset for the renderer.
float Phobos::Gui::RenderInterfaceOgre_c::GetVerticalTexelOffset()
{
